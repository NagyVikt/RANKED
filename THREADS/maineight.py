...
def update_products_with_additional_details(json_filename):
    ...
    for i, product in enumerate(products):
        ...
        if product_url:
            ...
            with open("brennenstuhl-hosszabbito-kabelek-es-lampatestek5.json", 'w', encoding='utf-8') as f:
...
if __name__ == "__main__":
    json_filename = 'brennenstuhl-hosszabbito-kabelek-es-lampatestek.json'
