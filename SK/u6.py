...
def get_subcategory_urls(category_url, api_key):
    ...
    subcategory_urls = []
    subcategory_tiles = soup.select('li a[href^="/ochranne-pracovne-prostriedky-delta-plus-"]')
...
category_url = "https://www.svx.sk/ochranne-pracovne-prostriedky-delta-plus/"
output_dir = "subcategories-ochranne-pracovne-prostriedky-delta-plus"
