...
def get_subcategory_urls(category_url, api_key):
    ...
    subcategory_urls = []
    subcategory_tiles = soup.select('li a[href^="/upinacie-pasy-gurtne-a-prislusenstvo-"]')
...
category_url = "https://www.svx.sk/upinacie-pasy-gurtne-a-prislusenstvo/"
output_dir = "subcategories-upinacie-pasy-gurtne-a-prislusenstvo"
