...
category_id = 92
total_pages = 50  # This is the variable you can redefine each run
...
def fetch_additional_details(product_info):
  ...
  # Extracting regular and sale price
    ...
    additional_details['categories'] = [{
        ...
        "name": "Ochranné pracovné prostriedky Delta plus",
        "slug": "ochranne-pracovne-prostriedky-delta-plus"
    }]
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/ochranne-pracovne-prostriedky-delta-plus/'  # Base URL of the category
    output_json_filename = 'ochranne-pracovne-prostriedky-delta-plus_new.json'
    existing_product_urls = load_existing_products('ochranne-pracovne-prostriedky-delta-plus.json')
