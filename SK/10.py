...
category_id = 86
total_pages = 28  # This is the variable you can redefine each run
...
def fetch_additional_details(product_info):
  ...
  # Extracting regular and sale price
    ...
    additional_details['categories'] = [{
        ...
        "name": "Laná, reťaze a sťahovacie pásky",
        "slug": "lana-retaze-a-stahovacie-pasky"
    }]
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/lana-retaze-a-stahovacie-pasky/'  # Base URL of the category
    output_json_filename = 'lana-retaze-a-stahovacie-pasky_new.json'
    existing_product_urls = load_existing_products('lana-retaze-a-stahovacie-pasky.json')
