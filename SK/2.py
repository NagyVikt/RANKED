...
category_id = 94
total_pages = 47  # This is the variable you can redefine each run
...
def fetch_additional_details(product_info):
  ...
  # Extracting regular and sale price
    ...
    additional_details['categories'] = [{
        ...
        "slug": "elektroinstalacny-material"
    }]
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/elektroinstalacny-material/'  # Base URL of the category
    output_json_filename = 'elektroinstalacny-material_new.json'
    existing_product_urls = load_existing_products('elektroinstalacny-material.json')
