...
category_id = 90
total_pages = 31  # This is the variable you can redefine each run
...
def fetch_additional_details(product_info):
  ...
  # Extracting regular and sale price
    ...
    additional_details['categories'] = [{
        ...
        "name": "Zdvíhacia a manipulačná technika YALE-PFAFF",
        "slug": "zdvihacia-a-manipulacna-technika-yale-pfaff"
    }]
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/zdvihacia-a-manipulacna-technika-yale-pfaff/'  # Base URL of the category
    output_json_filename = 'zdvihacia-a-manipulacna-technika-yale-pfaff_new.json'
    existing_product_urls = load_existing_products('zdvihacia-a-manipulacna-technika-yale-pfaff.json')
