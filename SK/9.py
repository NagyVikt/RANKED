...
category_id = 87
total_pages = 49  # This is the variable you can redefine each run
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/zdvihacia-technika-haky-a-retaze-tr-80-a-tr-100/'  # Base URL of the category
    output_json_filename = 'zdvihacia-technika-haky-a-retaze-tr-80-a-tr-100_new.json'
    existing_product_urls = load_existing_products('zdvihacia-technika-haky-a-retaze-tr-80-a-tr-100.json')
