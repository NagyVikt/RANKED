...
category_id = 89
total_pages = 7  # This is the variable you can redefine each run
...
def fetch_additional_details(product_info):
  ...
  # Extracting regular and sale price
    ...
    additional_details['categories'] = [{
        ...
        "name": "Upínacie pásy - gurtne a príslušenstvo",
        "slug": "upinacie-pasy-gurtne-a-prislusenstvo"
    }]
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/upinacie-pasy-gurtne-a-prislusenstvo/'  # Base URL of the category
    output_json_filename = 'upinacie-pasy-gurtne-a-prislusenstvo_new.json'
    existing_product_urls = load_existing_products('upinacie-pasy-gurtne-a-prislusenstvo.json')
