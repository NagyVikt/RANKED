...
def get_subcategory_urls(category_url, api_key):
    ...
    subcategory_urls = []
    subcategory_tiles = soup.select('li a[href^="/spojovaci-a-kotviaci-material-"]')
...
category_info = {
    "id": 95,
    "name": "Spojovací a kotviaci materiál",
    "slug": "spojovaci-a-kotviaci-material"
}

# Define the category URL and output directory
category_url = "https://www.svx.sk/spojovaci-a-kotviaci-material/"
output_dir = "subcategories-spojovaci-a-kotviaci-material"
