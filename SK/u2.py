...
def get_subcategory_urls(category_url, api_key):
    ...
    subcategory_urls = []
    subcategory_tiles = soup.select('li a[href^="/lana-retaze-a-stahovacie-pasky-"]')
...
category_url = "https://www.svx.sk/lana-retaze-a-stahovacie-pasky/"
output_dir = "subcategories-lana-retaze-a-stahovacie-pasky"
