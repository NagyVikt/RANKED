...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/pletiva/'  # Base URL of the category
    output_json_filename = 'pletiva_new.json'
    existing_product_urls = load_existing_products("pletiva.json")
