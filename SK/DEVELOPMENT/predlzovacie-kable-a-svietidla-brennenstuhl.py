...
def main():
    ...
    main_category_url = "https://kdtech.sk/shop/?filter_cat=predlzovacie-kable-a-svietidla-brennenstuhl"
    ...
    if category_data:
        ...
        output_file = "predlzovacie-kable-a-svietidla-brennenstuhl.json"
