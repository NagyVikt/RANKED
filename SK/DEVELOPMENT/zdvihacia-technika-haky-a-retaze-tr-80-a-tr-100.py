...
def main():
    ...
    main_category_url = "https://kdtech.sk/shop/?filter_cat=zdvihacia-technika-haky-a-retaze-tr-80-a-tr-100"
    ...
    if category_data:
        ...
        output_file = "zdvihacia-technika-haky-a-retaze-tr-80-a-tr-100.json"
