...
def get_subcategory_urls(category_url, api_key):
    ...
    subcategory_urls = []
    subcategory_tiles = soup.select('li a[href^="/domacnost-a-drogeria-"]')
...
category_url = "https://www.svx.sk/domacnost-a-drogeria/"
output_dir = "subcategories-domacnost-a-drogeria"
