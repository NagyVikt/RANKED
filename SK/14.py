...
category_id = 99
total_pages = 39  # This is the variable you can redefine each run
...
def fetch_additional_details(product_info):
  ...
  # Extracting regular and sale price
    ...
    additional_details['categories'] = [{
        ...
        "name": "Ložiská, guferá, klinové remene a príslušenstvo",
        "slug": "loziska-gufera-klinove-remene-a-prislusenstvo"
    }]
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/loziska-gufera-klinove-remene-a-prislusenstvo/'  # Base URL of the category
    output_json_filename = 'loziska-gufera-klinove-remene-a-prislusenstvo_new.json'
    existing_product_urls = load_existing_products('loziska-gufera-klinove-remene-a-prislusenstvo.json')
