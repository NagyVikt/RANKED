...
category_id = 97
total_pages = 77  # This is the variable you can redefine each run
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/naradie/'  # Base URL of the category
    output_json_filename = 'naradie_new.json'
    existing_product_urls = load_existing_products('naradie.json')
