...
category_id = 101
total_pages = 4  # This is the variable you can redefine each run
...
if __name__ == "__main__":
    base_category_url = 'https://www.svx.sk/magnety/'  # Base URL of the category
    output_json_filename = 'magnety_new.json'
    existing_product_urls = load_existing_products('magnety.json')
