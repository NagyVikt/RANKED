...
def get_subcategory_urls(category_url, api_key):
    ...
    subcategory_urls = []
    subcategory_tiles = soup.select('li a[href^="/elektroinstalacny-material-"]')
...
category_url = "https://www.svx.sk/elektroinstalacny-material/"
output_dir = "subcategories-elektroinstalacny-material"
