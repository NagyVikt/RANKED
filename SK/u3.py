...
def get_subcategory_urls(category_url, api_key):
    ...
    subcategory_urls = []
    subcategory_tiles = soup.select('li a[href^="/zdvihacia-technika-haky-a-retaze-tr-80-a-tr-100-"]')
...
category_url = "https://www.svx.sk/zdvihacia-technika-haky-a-retaze-tr-80-a-tr-100/"
output_dir = "subcategories-zdvihacia-technika-haky-a-retaze-tr-80-a-tr-100"
