...
def get_subcategory_urls(category_url, api_key):
    ...
    subcategory_urls = []
    subcategory_tiles = soup.select('li a[href^="/patky-uholniky-a-kovania-"]')
...
category_url = "https://www.svx.sk/patky-uholniky-a-kovania/"
output_dir = "subcategories-patky-uholniky-a-kovania"
