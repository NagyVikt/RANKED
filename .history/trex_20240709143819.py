...
def parse_description(description):
    ...
    for i, part in enumerate(description_parts):
        if part.lower() == 'processzor' and description_parts[i+1].lower() == 'típusa':
            cpu = ' '.join(description_parts[i+2:i+4])
        elif part.lower() == 'memória' and description_parts[i+1].lower() == 'mérete':
            ram = description_parts[i+2]
        elif part.lower() == 'memória' and description_parts[i+1].lower() == 'típusa':
            ram_type = description_parts[i+2]
        elif part.lower() == 'ssd':
            ssd = description_parts[i+1]
        elif part.lower() == 'gpu':
            gpu = ' '.join(description_parts[i+1:i+3])
